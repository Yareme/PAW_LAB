...
<body>
        <?php
        global $role;
        echo '<ol style="float: right; padding-right: 10px;" > ';
        echo $role;
            echo '</ol>';
        ?>
...
<a href="<?php print(_APP_ROOT); ?>/app/security/logout.php" style=" margin-left: 10px;" class="btn btn-primary mt-1 mb-2 ">Wyloguj</a>
